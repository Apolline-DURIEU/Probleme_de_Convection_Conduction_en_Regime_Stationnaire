# -*- coding: utf-8 -*-
"""
Created on Tue Jan  6 10:49:22 2026
...
N = 2*Ne+1; # taille de la matrice/vecteur
...
plt.suptitle("Profil de température dans le barreau (isolé en x=H)")
plt.grid();
plt.show;
