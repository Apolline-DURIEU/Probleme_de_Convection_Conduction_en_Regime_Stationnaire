# -*- coding: utf-8 -*-
"""
Created on Wed Dec 10 14:53:41 2025
...
X = LU(A1,B); # vecteur différence de temperature
print("X = ",X);
...
plt.title("Methode Linéaire", fontsize=9);
plt.suptitle("Profil de temperature dans le barreau (isolé en x=H)")
plt.grid();
plt.show;
...
t = 10; # tailles des matrices suivantes
...
plt.title("Méthode Linéaire", fontsize=9);
